...
class PaymentService:
    ...
    def _initiate_paystack_payment(self, payment):
        ...
        try:
            ...
            data = {
                ...
                "callback_url": f"{settings.BASE_URL}/api/payments/verify/{payment.payment_reference}/",
                "metadata": {
    ...
    def _mock_payment_initiation(self, payment):
        ...
        return {
            ...
            'authorization_url': f"{settings.BASE_URL}/mock-payment/{payment.payment_reference}/",
